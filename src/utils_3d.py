...
# def is_intersected_cstm(mesh: vtk.vtkPolyData, plane) -> bool:
#     """
...
def is_intersected(mesh: vtk.vtkPolyData, plane) -> bool:
    vp = _as_vtk_plane(plane)
    cutter = vtk.vtkCutter()
    cutter.SetCutFunction(vp)
    cutter.SetInputData(mesh)
...
def cut_polydata(poly: vtk.vtkPolyData, origin, normal) -> vtk.vtkPolyData:
